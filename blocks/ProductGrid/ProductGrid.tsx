...
export const ProductGrid: FC<ProductGridProps> = ({
  ...
  return (
    <>
    <div className="row">
      <div className="col-12 text-center"><button className="snipcart-checkout button" onClick={openSidebar}>View Cart (<span className="snipcart-items-count">{itemCount}</span>) &amp; Checkout</button></div>
    </div>
      <div className="row">
